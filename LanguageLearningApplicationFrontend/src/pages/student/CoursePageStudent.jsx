...
import { PlayCircleOutline, Star, Bookmark, Share, Lock } from "@mui/icons-material";
          ...
          <CardContent sx={{ 
            ...
            <Box>
              ...
              <Box sx={{ display: "flex", gap: 1 }}>
                ...
                />
                <Chip label={`${course.videos.length} Lessons`} color="primary" variant="outlined" />
              </Box>
            </Box>
            <Box sx={{ 
              display: "flex", 
            ...
            {reviewsLoading ? (
              ...
              <Box sx={{ maxHeight: "600px", overflowY: "auto", pr: 1 }}>
                {reviews.map((review, index) => (
                  <Box key={index} sx={{ mb: 3, pb: 2, borderBottom: index < reviews.length - 1 ? "1px solid" : "none", 
                    borderColor: "divider" }}>
                    <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                      <Avatar src={review.studentProfilePic} alt={review.studentName} sx={{ mr: 2 }} />
                      <Box>
                        <Typography fontWeight="medium">{review.studentName}</Typography>
